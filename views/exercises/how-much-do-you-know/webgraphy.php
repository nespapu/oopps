...
$action = $url->to(
    $howMuchDoYouKnowPaths->webgraphyEvaluation($sessionId)
);
...
$nextUrl = $url->to(
    $howMuchDoYouKnowPaths->resultStep($sessionId)
);
  ...
  <div class="col-12 col-xl-11">
    ...
    <div class="d-flex align-items-start justify-content-between mb-3">
      <div>
        ...
        <div class="text-muted">
          Paso:
          <span class="fw-semibold">Webgrafía</span>
        </div>
      </div>
        ...
        <?php if ($isStepCorrect): ?>
          ...
          >
            ...
            <div>
              ...
              Puedes continuar al resultado del ejercicio.
            </div>
          </div>
        <?php else: ?>
          <div
          ...
          >
            ...
            <div>
              ...
              Revisa los nombres y las direcciones de los sitios web.
            </div>
          </div>
        <?php endif; ?>
      <?php endif; ?>
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        <div class="mb-4">
          <h2 class="h5 mb-1">
            Completa la webgrafía del tema
          </h2>

          <p class="text-muted mb-0">
            Cada tarjeta representa un recurso web utilizado en el tema.
            Completa únicamente los campos que aparecen vacíos.
          </p>
        </div>

        <?php if ($items === []): ?>
          <div class="alert alert-warning mb-0" role="alert">
            No se han encontrado referencias web para este tema.
          </div>
        <?php else: ?>
          <form method="post" action="<?= $e($action) ?>">

            <?php foreach ($items as $position => $website): ?>
              <?php
                if (!is_array($website)) {
                    continue;
                }
                ...
                <div class="card-body">
                  <div class="row g-4">
                    ...
                    <?php foreach ($fieldDefinitions as $fieldName => $definition): ?>
                      <?php
                        $field = is_array($website[$fieldName] ?? null)
                            ? $website[$fieldName]
                            : [];
