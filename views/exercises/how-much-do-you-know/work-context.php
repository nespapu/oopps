...
$action = $url->to(
    $howMuchDoYouKnowPaths->workContextEvaluation($sessionId)
);
...
$nextUrl = $url->to(
    $howMuchDoYouKnowPaths->bibliographyStep($sessionId)
);
  ...
  <div class="col-12 col-xl-11">
    ...
    <div class="d-flex align-items-start justify-content-between mb-3">
      <div>
        ...
        <div class="text-muted">
          Paso:
          <span class="fw-semibold">Contexto laboral</span>
        </div>
      </div>
        ...
        <?php else: ?>
          ...
          >
            ...
            <div>
              ...
              Revisa los datos y las explicaciones del contexto laboral.
            </div>
          </div>
        <?php endif; ?>
      <?php endif; ?>
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        <div class="mb-4">
          <h2 class="h5 mb-1">
            Completa el contexto laboral del tema
          </h2>

          <p class="text-muted mb-0">
            Cada tarjeta representa una aplicación del contenido en el ámbito
            profesional. Completa únicamente los campos que aparecen vacíos.
          </p>
        </div>

        <?php if ($items === []): ?>
          <div class="alert alert-warning mb-0" role="alert">
            No se han encontrado elementos de contexto laboral para este tema.
          </div>
        <?php else: ?>
          <form method="post" action="<?= $e($action) ?>">

            <?php foreach ($items as $position => $workContext): ?>
              <?php
                if (!is_array($workContext)) {
                    continue;
                }
              ...
              <section class="card mb-4 border">
                ...
                >
                  <div class="d-flex align-items-center gap-2">
                    ...
                    <h3 class="h6 mb-0">
                      Contexto laboral <?= $e((int) $position + 1) ?>
                    </h3>
                  </div>
                </div>
                  ...
                  <div class="row g-4">
                    ...
                    <?php foreach ($fieldDefinitions as $fieldName => $definition): ?>
                      <?php
                         ...
                         *
                         * Actualmente este comportamiento afecta al rol
                         * profesional, que puede ser nulo.
                         */
                        if (!array_key_exists($fieldName, $workContext)) {
                            continue;
                        }

                        $field = is_array($workContext[$fieldName])
                            ? $workContext[$fieldName]
                            : [];
                        ...
                        $answerKey = $workContextKey
                            . '.'
                            . $fieldName;

                        $inputId = $workContextKey
                            . '_'
                            . $fieldName;
                        ...
                        <?php if ($type === 'textarea'): ?>
                          ...
                          <?php if ($isEvaluable): ?>
                            <textarea
                              ...
                              id="<?= $e($inputId) ?>"
                              name="<?= $e($workContextKey) ?>[<?= $e($fieldName) ?>]"
                              rows="<?= $e($rows) ?>"
                              placeholder="<?= $e($hint) ?>"
                              required
