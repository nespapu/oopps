...
final class JustificationPayloadBuilderTest extends TestCase
{
    public function testBuildsPayloadWithHintsAndExpectedValues(): void
    {
        ...
        $this->assertSame(EvaluationMode::EQUALITY, $payload[StepPayloadKeys::ITEMS][0]['laws'][0]['evaluation']['mode']);
        ...
        $this->assertSame(EvaluationMode::EQUALITY, $payload[StepPayloadKeys::ITEMS][0]['laws'][1]['evaluation']['mode']);
        ...
        $this->assertSame(EvaluationMode::EQUALITY, $payload[StepPayloadKeys::ITEMS][0]['modules'][0]['evaluation']['mode']);
        ...
        $this->assertSame(EvaluationMode::EQUALITY, $payload[StepPayloadKeys::ITEMS][1]['laws'][0]['evaluation']['mode']);
        ...
        $this->assertSame(EvaluationMode::EQUALITY, $payload[StepPayloadKeys::ITEMS][1]['modules'][0]['evaluation']['mode']);
        ...
        $this->assertSame(EvaluationMode::EQUALITY, $payload[StepPayloadKeys::ITEMS][1]['modules'][1]['evaluation']['mode']);
